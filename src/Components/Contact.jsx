                ...
                <div className="contactInner">
                    <div className="row my-5">
                        ...
                        <div className="col-12 col-md-6">
                            <h4>Get in touch</h4>
                            <ul>                                
                                <li><span><MdCall /></span><a href="tel:+8801996722640">01996722640</a></li>
                                <li><span><IoLogoWhatsapp /></span><a href="https://wa.me/+8801996722640/?text='Hello" rel="noreferrer" target='_blank'>01996722640</a></li>
                                <li><span><MdEmail /></span><a href="mailto:ranarr.dev@gmail.com">ranarr.dev@gmail.com</a></li>
                                <li><span><ImLocation /></span>Dhaka,Bangladesh</li>
                            </ul>
                        </div>
                        <div className="col-12 col-md-6">
                    ...
                    <div className="row my-3">
                        <div className="col-12 text-center">
                            ...
                            <br />
                            <span className="footerText">version 2.1</span>
                        </div>
                    </div>
                </div>
            </section>
